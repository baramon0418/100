...
<body>
  ...
  " type="text" title="Search">
        ...
        <ul class="menu">
        <li>
        <a href="./whatiscodecure1.php">동아리소개</a>
        <ul class="submenu">
          <li><a href="./whatiscodecure1.php">코드큐어란?</a></li>
          <li><a href="./whatiscodecure2.php">동아리 소개</a></li>
          <li><a href="./whatiscodecure3.php">임원진 소개</a></li>
        </ul>
      </li>
      <li>
        <a href="../notice/index.php?board=211&&page=1">공지사항</a>
        <ul class="submenu">
          <li><a href="../notice/index.php?board=211&&page=1">기초팀</a></li>
          <li><a href="../notice/index.php?board=212&&page=1">개발팀</a></li>
          <li><a href="../notice/index.php?board=213&&page=1">해킹팀</a></li>
        </ul>
      </li>
      <li>
        <a href="../team/index.php?board=221&&page=1">팀별 게시판</a>
        <ul class="submenu">
          <li><a href="../team/index.php?board=221&&page=1">기초팀</a></li>
          <li><a href="../team/index.php?board=221&&page=1">개발팀</a></li>
          <li><a href="../team/index.php?board=221&&page=1">해킹팀</a></li>
        </ul>
      </li>
      <li>
        <a href="#">자유 게시판</a>
